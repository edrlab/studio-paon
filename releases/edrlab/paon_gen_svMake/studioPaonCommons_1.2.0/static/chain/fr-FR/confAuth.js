...
reg.registerSvc('area.users.email.user', 21, new Promise(async (resolve)=>{
					const {UserEmailInputArea} = await import("https://studio-paon.edrlab.org/~~static/scCore/fr-FR/-wbk/6.1.10.202401191026/core/dialogs/userAreas.js");
			...
			reg.addToList("userProps:create:users", 'authMethod', 21, new Promise(async (resolve)=>{
				...
				const {PasswordInputArea, userAreaIsVisible, userAreaIsEnabled} = await import("https://studio-paon.edrlab.org/~~static/scCore/fr-FR/-wbk/6.1.10.202401191026/core/dialogs/userAreas.js");
							...
							let area = new SelectSubPanelArea('authMethod')
								...
								.setDefaultValue("");
							area.setDataset(
								{"":{label:"Interne",areas:[new SelectSubPanelArea('passwordSetMode')
								...
								),],disabled:String("")==="true",},remote:{label:"Centralisée (annuaire LDAP)",areas:[],disabled:String("true")==="true",},}
							);
		...
		reg.addRolePermList([
				{
					...
					new CoreUniverse(Object.assign({
						...
						userSelf:{
							...
							usersAspects:["groupable","rolable","oneNickName","hideable","updatable","enabledEndDt",],
						},
						adminUsers:{
							usersAspects:["groupable","rolable","oneNickName","hideable","updatable","enabledEndDt",],
						},
            	...
            	usersAspects:["groupable","rolable","oneNickName","hideable","updatable","enabledEndDt",],
						...
						universeUrl:new AuthEndPoint("https://studio-paon.edrlab.org/~~chain/"),
						...
						frontUrl:new PublicEndPoint(IO.absoluteUrl("https://studio-paon.edrlab.org/~~static/chain/fr-FR/")),
					}, ovrUnivConf));
				}
